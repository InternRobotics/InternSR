...
if __name__ == "__main__":
    ...
    parser.add_argument("--video-folder", type=str, default="/mnt/petrelfs/linjingli/st_new/spatio-temporal-benchmark/VLMEvalKit_/to_transfer/data/images/mmscan")
    parser.add_argument("--question-file", type=str, default="/mnt/petrelfs/linjingli/mmscan_modelzoo-main/llmzoo/LLaVA-3D-Beta/scripts/llava_mmscan_QA_val_0.01.json")
    parser.add_argument("--answers-file", type=str, default="./llava3d_mmscan_val_pred_new2.json")
